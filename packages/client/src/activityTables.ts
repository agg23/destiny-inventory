...
export const activityTables = cached(async (): Promise<ActivityTables> => {
  ...
  const [
    ...
    fetchTable<Table<SlimGraphNode>>(artifacts, "FireteamFinderActivityGraph"),
    fetchTable<Table<SlimActivitySet>>(artifacts, "FireteamFinderActivitySet"),
